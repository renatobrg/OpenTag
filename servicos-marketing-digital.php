    ...
    <section class="topo">
        <div class="wrap-container" data-aos="fade-up" data-aos-duration="2000">
            <article class="content">
                <h1 class="content__title">Marketing Digital</h1>
                <span class="content__breadcrumbs">Home | Serviços | Marketing Digital</span>
            </article>
        </div>
    </section>
    ...
    <main class="servicos-int">
        <div class="wrap-container">
            <article class="content" data-aos="fade-up" data-aos-duration="2000">
                <h2 class="content__title pages">Marketing Digital</h2>
            ...
            <aside class="barra-servicos" data-aos="fade-up" data-aos-duration="2000">
                ...
                <ul class="lista">
                    ...
                    <li class="lista__item">
                        <a href="servicos-marketing-digital.html" title="Ir para Marketing Digital" class="active">
