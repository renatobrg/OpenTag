    ...
    <section class="topo">
        <div class="wrap-container" data-aos="fade-up" data-aos-duration="2000">
            <article class="content">
                <h1 class="content__title">SEO e Google Ads</h1>
                <span class="content__breadcrumbs">Home | Serviços | SEO e Google Ads</span>
            </article>
        </div>
    </section>
    ...
    <main class="servicos-int">
        <div class="wrap-container">
            <article class="content" data-aos="fade-up" data-aos-duration="2000">
                ...
                <h3 class="content__title3">O que <strong>SEO E Google Ads</strong> engloba?</h3>
                <ul class="content__list-services">
                    <li></li>
                    <li>Estrutura de sites</li>
                    <li>Conteúdo de qualidade</li>
                    <li>Planejamento de palavras-chave</li>
                    <li>Landing Pages para captação de clientes</li>
