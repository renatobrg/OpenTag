    ...
    <section class="topo">
        <div class="wrap-container" data-aos="fade-up" data-aos-duration="2000">
            <article class="content">
                <h1 class="content__title">SEO e AdWords</h1>
                <span class="content__breadcrumbs">Home | Serviços | SEO e AdWords</span>
            </article>
        </div>
    </section>
    ...
    <main class="servicos-int">
        <div class="wrap-container">
            <article class="content" data-aos="fade-up" data-aos-duration="2000">
                <h2 class="content__title pages">SEO e AdWords</h2>
            ...
            <aside class="barra-servicos" data-aos="fade-up" data-aos-duration="2000">
                ...
                <ul class="lista">
                    ...
                    <li class="lista__item">
                        <a href="servicos-seo-adwords.html" title="Ir para SEO e AdWords" class="active">
